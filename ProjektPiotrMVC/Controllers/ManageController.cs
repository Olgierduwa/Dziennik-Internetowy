...
namespace ProjektPiotrMVC.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            return RedirectToAction("VerifyPhoneNumber", new { PhoneNumber = model.Number, Number = code });
        }
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber, string number)
        {
            var code = await UserManager.GenerateChangePhoneNumberTokenAsync(User.Identity.GetUserId(), phoneNumber);
            // Wyślij wiadomość SMS za pośrednictwem dostawcy usług SMS w celu zweryfikowania numeru telefonu
            return phoneNumber == null ? View("Error") : View(new VerifyPhoneNumberViewModel { PhoneNumber = phoneNumber, Code = number });
        }
